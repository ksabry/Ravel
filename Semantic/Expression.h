...
namespace Ravel
{
    namespace Semantic
    {
        ...
        public:
            ...
            static friend bool operator==(Expression const & left, Expression const & right);
            static inline friend bool operator!=(Expression const & left, Expression const & right)
            {
                return !(left == right);
            }
