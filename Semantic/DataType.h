...
namespace Ravel
{
    namespace Semantic
    {
        ...
        template<>
        static inline DataType GetAssociatedDataType<uint32_t>()
        {
            return TYPE_UINT32;
        }
        template<>
        static inline DataType GetAssociatedDataType<uint64_t>()
        {
            return TYPE_UINT64;
        }
        template<>
        static inline DataType GetAssociatedDataType<int32_t>()
        {
            return TYPE_INT32;
        }
        template<>
        static inline DataType GetAssociatedDataType<int64_t>()
        {
            return TYPE_INT64;
        }
        template<>
        static inline DataType GetAssociatedDataType<float>()
        {
            return TYPE_FLOAT32;
        }
        template<>
        static inline DataType GetAssociatedDataType<double>()
        {
            return TYPE_FLOAT64;
        }
    }
