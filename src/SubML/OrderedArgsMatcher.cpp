...
namespace Ravel
{
    namespace SubML
    {
        ...
        void OrderedArgsMatcher::BeginInternal()
        {
            ...
            stack_idx = 0;
            matchers_idx_stack = new size_t [matcher_count] { 0 };
        ...
        void ** OrderedArgsMatcher::NextInternal()
        {
            ...
            while (!result)
            {
                size_t matchers_idx = matchers_idx_stack[stack_idx];
        ...
        bool OrderedArgsMatcher::PushStackUntilLast()
        {
            while (stack_idx < static_cast<int32_t>(matcher_count) - 1)
            {
                ...
                size_t exprs_start_idx = bounds_stack[matcher_count * stack_idx + matchers_idx].start;
        ...
        bool OrderedArgsMatcher::PushStack(void ** new_captures, Bounds exprs_bounds)
        {
            ...
            size_t old_matchers_idx = matchers_idx_stack[stack_idx];
        ...
        bool OrderedArgsMatcher::SetupStack(bool bounds_set)
        {
            ...
            size_t next_start_idx = bounds[next_idx].start;
            size_t next_end_idx = next_start_idx;
        ...
        bool OrderedArgsMatcher::CalculateBounds(size_t max_length, Bounds * result)
        {
        ...
        bool OrderedArgsMatcher::MatcherAvailable(size_t idx)
        {
        ...
        void OrderedArgsMatcher::GetMatcherLowHigh(size_t idx, size_t * low, size_t * high)
        {
